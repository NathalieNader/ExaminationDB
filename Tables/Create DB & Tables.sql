...
CREATE TABLE ModelAnswer (
    ...
    OptionID INT FOREIGN KEY REFERENCES [Option](OptionID) ON DELETE NO ACTION
);
...
CREATE TABLE Exam_Question (
    ...
    QuestionID INT FOREIGN KEY REFERENCES Question(QuestionID) ON DELETE NO ACTION,
    OrderNo INT,
...
CREATE TABLE StudentExam (
    ...
    ExamID INT FOREIGN KEY REFERENCES Exam(ExamID) ON DELETE NO ACTION,
    StartTime DATETIME,
    EndTime DATETIME,
    TotalGrade INT 
);
...
CREATE TABLE StudentAnswer (
    ...
    QuestionID INT FOREIGN KEY REFERENCES Question(QuestionID) ON DELETE NO ACTION,
    ChosenOptionID INT FOREIGN KEY REFERENCES [Option](OptionID) ON DELETE NO ACTION 
);